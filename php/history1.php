...
<main>
	...
	<section style=" color:#666; background-color:white;"><br>
		<div class="row3">
					...
					<h2 style="font-size:2.5em; text-align:center; padding-left:15%; padding-right:15%; padding-top:5px; padding-bottom: 5px;background-color:white; margin-top:0px;"><strong>DWCC HISTORY</strong></h2>
						<div class="card" style="  background-color:white;   margin-top:0px;">
							<article>
								...
								was granted. A re-accreditation was given in 1998.</p><br>
								...
								In 2002 the Elementary Department building located adjacent to the High School Department building at the Freinademetz campus was completed. 
								In the succeeding year the Elementary Department transferred to its new site, thus housing together the Basic Education Department in that campus.
